...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN', "6259209201:AAGFe3COKADKIkG2G55aniQN2FBYuS3S9lI"))
    ...
    OWNER_ID = int(getenv('OWNER_ID', '5469155535'))
    NO_PORT = bool(getenv('NO_PORT', False))
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', "Itachi752"))
    if 'DYNO' in environ:
        ON_HEROKU = True
        APP_NAME = str(getenv('APP_NAME', "linkgeneratorxbot"))
    else:
        ON_HEROKU = False
